//
//  ReceivePublicKeyViewController.m
//  BTLE Transfer
//
...
static CGFloat kTextViewFontSize = 15.0f;
static CGSize kTextViewSize = (CGSize){300.0f, 200.0f};
static UIEdgeInsets kTextViewInsets = (UIEdgeInsets){8.0f, 8.0f, 8.0f, 8.0f};

@interface ReceivePublicKeyViewController () <CBCentralManagerDelegate, CBPeripheralDelegate>
...
@implementation ReceivePublicKeyViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTitle:@"公開鍵を受け取る"];
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error
{
    ...
    if ([stringFromData isEqualToString:@"EOM"]) {
        ...
        if (components.count==2) {
            [[NSUserDefaults standardUserDefaults] setObject:components[0] forKey:@"public1"];
            [[NSUserDefaults standardUserDefaults] setObject:components[1] forKey:@"public2"];
            [_textview setText:@"公開鍵を受信しました"];
        } else {
            UIAlertController *controller = [UIAlertController alertControllerWithTitle:@"エラー" message:@"不正な形式です" preferredStyle:UIAlertControllerStyleAlert];
